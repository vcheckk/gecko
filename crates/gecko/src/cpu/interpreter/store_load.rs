...
#[inline(always)]
pub fn lswi(ctx: &mut crate::gamecube::GameCube, instr: crate::cpu::instruction::Instruction) {
    let ea = ctx.cpu.read_gpr_or_zero(instr.ra());
    let nb = instr.nb();
...
#[inline(always)]
pub fn stswi(ctx: &mut crate::gamecube::GameCube, instr: crate::cpu::instruction::Instruction) {
    let ea = ctx.cpu.read_gpr_or_zero(instr.ra());
    let nb = instr.nb();
    let mut n = if nb == 0 { 32u32 } else { nb as u32 };
    let mut r = (instr.rs() as u32).wrapping_sub(1) & 31;
...
#[inline(always)]
pub fn eciwx(ctx: &mut crate::gamecube::GameCube, instr: crate::cpu::instruction::Instruction) {
    let ea = ctx
        .cpu
        .read_gpr_or_zero(instr.ra())
        .wrapping_add(ctx.cpu.read_gpr(instr.rb()));
...
#[inline(always)]
pub fn ecowx(ctx: &mut crate::gamecube::GameCube, instr: crate::cpu::instruction::Instruction) {
    let ea = ctx
        .cpu
        .read_gpr_or_zero(instr.ra())
        .wrapping_add(ctx.cpu.read_gpr(instr.rb()));
